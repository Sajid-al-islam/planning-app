        ...
        <div class="pt-2">
            <div class="page-header my-2">
                <div class="row align-items-center rounded-2">
                    <div class="col-lg-6">
                        <h5 class="m-0">Chok Management</h5>
                    </div>
            ...
            <div class="conatiner">
                <div class="card list_card">
                    ...
                    <div class="table-responsive card-body text-nowrap">
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody class="table-border-bottom-0">
                                <tr v-for="(item, index) in all_chokss.data" :key="index">
                                    <td>
                                        <input type="checkbox" class="form-check-input" />
                                    </td>
                                    <td>{{ item.id }}</td>
                    ...
                    <div class="card-footer py-1 border-top-0 d-flex justify-content-between border border-1">
                        <pagination :data="all_chokss" :method="choks_get_all" />
...
export default {
    ...
    watch: {
        ...
        search_data: debounce(async function (newSearchData, oldSearchData) {
            ...
            await this.choks_get_all("yearly-plan-choks?search="+newSearchData);
        }, 500),
    },
};
</script>

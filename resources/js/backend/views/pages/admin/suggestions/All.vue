        ...
        <div class="pt-2">
            <div class="page-header my-2">
                <div class="row align-items-center rounded-2">
                    <div class="col-lg-6">
                        <h5 class="m-0">suggestion Management</h5>
                    </div>
            ...
            <div class="conatiner">
                <div class="card list_card">
                    ...
                    <div class="table-responsive card-body text-nowrap">
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody class="table-border-bottom-0">
                                <tr v-for="(item, index) in all_suggestions.data" :key="index">
                                    <td>
                                        <input type="checkbox" class="form-check-input" />
                                    </td>
                                    <td>{{ item.id }}</td>
                                    ...
                                    <td>
                                        <span v-if="item.user" class="cursor_pointer text-warning">
                                            {{ item.user.full_name }}
                                        </span>
                                    </td>
                    ...
                    <div class="card-footer py-1 border-top-0 d-flex justify-content-between border border-1">
                        <pagination :data="all_suggestions" :method="suggestion_get_all" />
                        <div class="float-right">
                            ...
                            <div class="show-limit d-inline-block">
                                <span>Total:</span>
                                <span>{{ all_suggestions.total }}</span>
                            </div>
                        </div>
                    </div>
                </div>

        ...
        <div class="pt-2">
            <div class="page-header my-2">
                <div class="row align-items-center rounded-2">
                    <div class="col-lg-6">
                        <h5 class="m-0">Plan Management</h5>
                    </div>
                    <div class="col-lg-6 text-end">
                        <span>
                            <router-link
                                :to="{ name: `CreatePlanDetails` }"
            ...
            <div class="conatiner">
                <div class="card list_card">
                    ...
                    <div class="table-responsive card-body text-nowrap">
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody class="table-border-bottom-0">
                                <tr
                                    v-for="(item, index) in all_plans.data"
                                    :key="item.id"
                                >
                                    <td>
                                        <input
                                    ...
                                    <td>
                                        <span class="badge bg-label-success me-1" v-if="item.is_approved == 1">
                                            Approved
                                        </span>
                                        <span class="badge bg-label-success me-1" v-else>
                                            Not Approved
                                        </span>
                                    </td>
                    ...
                    >
                        <pagination :data="all_plans" :method="plan_get_all" />
...
export default {
    ...
    created: async function () {
        await this.plan_get_all("yearly-plan-details");
    },
    methods: {
    ...
    watch: {
        ...
        search_data: async function (newSearchData, oldSearchData) {
            await this.plan_get_all("yearly-plan-details?search="+newSearchData);
        },
    },
};
</script>
